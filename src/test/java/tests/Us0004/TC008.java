...
public class TC008 {
    ...
    public void testCase08() {
        ...
        Assert.assertTrue(myAccountPage.shoppingCartProceedToCheckoutButton.isDisplayed());
        myAccountPage.shoppingCartProceedToCheckoutButton.click();
        Assert.assertTrue(myAccountPage.checkoutPageVerifyCheckoutPage.isDisplayed());
        Driver.closeDriver();
    }
}